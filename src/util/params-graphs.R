...
## Some families and genera are in italics 
# to define that I will create some functions to easily perform this changes 
fams.italy <- c('Puniceispirillaceae','Cyanobiaceae', 'Pseudohongiellaceae',
                'Halieaceae', 'Porticoccaceae', 'Flavobacteriaceae',
                'Pelagibacteraceae','Rhodobacteraceae')
genus.italy <- c('Puniceispirillum', 'Pelagibacter',
                 'Luminiphilus', 'Litoricola')
