...
SimpleRareToPrev.f=function(otu_fp,outitle,abund_thresh = 0.005, abund_thresh_ALL=FALSE,b_thresh = 0.90, rdp_lastcol=TRUE){
  ...
  write.table(out.filter, paste("data/analysis/ResultsFile_ConditionallyRareOTUID_",outitle, abund_thresh, "_", b_thresh, "_", at, ".txt", sep=""), quote=FALSE, sep="\t", row.names=FALSE)
